...
export default function LogoPage() {
  return (
    <Frame>
      {/* top radial glow */}
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", background: "radial-gradient(120% 70% at 50% -10%,rgba(108,79,147,.16),transparent 60%)", zIndex: 0 }} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 22, marginTop: 48 }}>
          ...
          <div data-reveal="" style={{ position: "relative", aspectRatio: "1/1", border: "1px solid rgba(233,226,211,.16)", background: "#13101b", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", width: 128, height: 128 }}>
              <div style={{ position: "absolute", inset: 0, border: "1.5px solid #c4a9e0", borderRadius: "50%" }} />
              <div style={{ position: "absolute", inset: 0, borderRadius: "50%", animation: "rot 14s linear infinite" }}>
                <div style={{ position: "absolute", top: -5, left: "50%", width: 10, height: 10, marginLeft: -5, borderRadius: "50%", background: "#a585cf" }} />
              </div>
              <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: MONO, fontWeight: 700, fontSize: 30, letterSpacing: "-.02em", color: "#e9e2d3" }}>il</div>
            </div>
          </div>
          ...
          <div data-reveal="" style={{ position: "relative", aspectRatio: "1/1", border: "1px solid rgba(233,226,211,.16)", background: "#13101b", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 10, overflow: "hidden" }}>
            ...
            <div style={{ fontSize: 46, letterSpacing: "-.02em", color: "#e9e2d3", lineHeight: 1 }}>
              in the l
              <span style={{ display: "inline-block", border: "2.5px solid #c4a9e0", borderRadius: "50%", width: 30, height: 30, verticalAlign: -4, margin: "0 -2px" }} />
              <span style={{ display: "inline-block", border: "2.5px solid #a585cf", borderRadius: "50%", width: 30, height: 30, verticalAlign: -4, margin: "0 -2px" }} />
              p
            </div>
          ...
          <div data-reveal="" style={{ position: "relative", aspectRatio: "1/1", border: "1px solid rgba(233,226,211,.16)", background: "#13101b", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            ...
            <div style={{ position: "relative", width: 150, height: 150, borderRadius: "50%", border: "1px solid rgba(196,169,224,.5)", display: "flex", alignItems: "center", justifyContent: "center" }}>
              <div style={{ position: "absolute", inset: 9, borderRadius: "50%", border: "1px solid rgba(196,169,224,.25)" }} />
              <div style={{ position: "absolute", inset: 0, animation: "rot 40s linear infinite", fontFamily: MONO, fontSize: 9, letterSpacing: ".34em", textTransform: "uppercase", color: "#9a8ea4" }}>
                <div style={{ position: "absolute", top: 14, left: "50%", transform: "translateX(-50%)" }}>· software · research · development ·</div>
              </div>
              <div style={{ fontFamily: BLACKLETTER, fontSize: 60, color: "#e9e2d3", lineHeight: ".8" }}>il</div>
            </div>
          </div>
          ...
          <div data-reveal="" style={{ position: "relative", aspectRatio: "1/1", border: "1px solid rgba(233,226,211,.16)", background: "#13101b", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            ...
            <div style={{ fontFamily: MONO, fontWeight: 500, fontSize: 22, letterSpacing: "-.01em", color: "#e9e2d3", display: "flex", alignItems: "center", gap: 2 }}>
              <span style={{ color: "#a585cf" }}>[</span>intheloop<span style={{ color: "#a585cf" }}>]</span>
            </div>
          </div>
          ...
          <div data-reveal="" style={{ position: "relative", aspectRatio: "1/1", border: "1px solid rgba(233,226,211,.16)", background: "#13101b", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
            ...
            <div style={{ textAlign: "center" }}>
              <div style={{ fontFamily: MONO, fontSize: 9, letterSpacing: ".3em", textTransform: "uppercase", color: "#82749a" }}>est. mmxxvi</div>
              <div style={{ fontSize: 40, letterSpacing: "-.01em", color: "#e9e2d3", lineHeight: 1.05, margin: "6px 0" }}>intheloop</div>
              <div style={{ width: 54, height: 1, background: "#7c5fa6", margin: "0 auto 6px" }} />
              <div style={{ fontFamily: MONO, fontSize: 9, letterSpacing: ".3em", textTransform: "uppercase", color: "#82749a" }}>software studio</div>
            </div>
          </div>
          ...
          <div data-reveal="" style={{ position: "relative", aspectRatio: "1/1", border: "1px solid rgba(233,226,211,.16)", background: "#13101b", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 18, overflow: "hidden" }}>
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              <div style={{ width: 46, height: 46, border: "2.5px solid #c4a9e0", borderRadius: "50%" }} />
              <div style={{ width: 46, height: 46, border: "2.5px solid #a585cf", borderRadius: "50%", marginLeft: -16 }} />
            </div>
            <div style={{ fontFamily: MONO, fontSize: 13, letterSpacing: ".04em", color: "#e9e2d3" }}>intheloop</div>
          </div>
        </div>
        ...
        <div data-reveal="" style={{ marginTop: 48, border: "1px solid rgba(233,226,211,.15)", background: "linear-gradient(180deg,#15101e,#100b18)", padding: "72px 48px", display: "flex", alignItems: "center", justifyContent: "center", gap: 30, flexWrap: "wrap" }}>
          <div style={{ position: "relative", width: 64, height: 64, flex: "none" }}>
            ...
            <div style={{ position: "absolute", inset: 0, borderRadius: "50%", animation: "rot 16s linear infinite" }}>
              <div style={{ position: "absolute", top: -4, left: "50%", width: 8, height: 8, marginLeft: -4, borderRadius: "50%", background: "#a585cf" }} />
            </div>
          </div>
