...
const BLACKLETTER = "var(--font-unifraktur), cursive";
    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          backgroundImage:
            "radial-gradient(rgba(180,164,200,.08) 1px,transparent 1px)",
        ...
        <div style={{ borderBottom: "1px solid rgba(233,226,211,.15)", fontFamily: MONO }}>
          <div style={{ maxWidth: 1320, margin: "0 auto", padding: "22px 40px", display: "flex", alignItems: "center", gap: 22, flexWrap: "wrap" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, fontSize: 11, letterSpacing: ".14em", textTransform: "uppercase", flexWrap: "wrap" }}>
              <Link href="/" className="il-navlink">Home</Link>
              <span style={{ color: "#7c5fa6" }}>/</span>
              <Link href="/portfolio" className="il-navlink">Portfolio</Link>
              <span style={{ color: "#7c5fa6" }}>/</span>
              <span style={{ color: "#c4a9e0" }}>Distributed Systems</span>
            </div>
          </div>
        </div>
