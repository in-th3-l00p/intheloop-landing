...
export default function TopBar({ crumbs }: { crumbs?: Crumb[] }) {
  return (
    <div style={{ borderBottom: "1px solid rgba(230,230,226,.15)", fontFamily: MONO }}>
